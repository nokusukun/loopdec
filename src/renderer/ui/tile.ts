...
import { initTilePlugins, serializeTilePlugins } from '../plugins/registry';
...
export function loadVideo(tile: Tile, source: Source): void {
  ...
  video.playbackRate = getSpeed(tile);
...
function makeTile(
  ...
  initTilePlugins(tile, pluginState);
  return tile;
}
